...
> 语言：[English](SAS_VERIFICATION_KNOWLEDGE.md) | [中文](SAS_VERIFICATION_KNOWLEDGE.zh.md)
...
>
> 配套文档：[`docs/DEVICE_VERIFICATION.zh.md`](DEVICE_VERIFICATION.zh.md)（人话操作指南 + 源码级流程）、
> [`SECURITY.md`](../SECURITY.md)（信任模型与威胁边界，仅英文）、[`docs/DEVELOPMENT.zh.md`](DEVELOPMENT.zh.md)（测试纪律）。
>
...
| W1N-157 | F 人话版验证指南（docs/DEVICE_VERIFICATION.zh.md） | — | ✅ |
...
- 已发布至 **v0.3.10**（wire 修复线：commitment v0.2.8 → emoji v0.2.9 → legacy MAC v0.2.10；v0.3 起加入 Options Flow
  设备验证向导 + `m.key.verification.done` 收尾；v0.3.4–v0.3.7 依次补齐文档、日志降噪、Config Entry diagnostics、
  连接健康实体；v0.3.8 拆分 allowlist；v0.3.9 UI 打磨与维护；v0.3.10 文档中英双版本）。
